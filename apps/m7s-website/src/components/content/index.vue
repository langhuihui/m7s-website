  ...
  <div class="content">
        ...
        <div class="m7s-feature">
          <div class="tab">
            <div class="item" @click="change(index)" v-for="(item, index) in list"
              :class="active == index ? 'active' : ''">{{ item.title }}</div>
          </div>
    ...
    <section id="plugin">
      <div class="box">
        ...
        <div class="tab">
          <div class="item" @click="change2(index)" v-for="(item, index) in list2"
            :class="active2 == index ? 'active' : ''">{{ item }}</div>
        </div>
    ...
    <section id="ui">
      <div class="box">
        ...
        <div class="ui-content">
          ...
          <div>
            <a name="ui" href="https://console.monibuca.com" target="_blank">
              <div class="btn">使用在线版</div>
            </a>
